...
import WellFoundLogo from '@/app/wellfound_logo.png';
...
export function MobileNav({ onOpen, ...rest }: MobileProps) {
  ...
  const handleJobSelection = (event) => {
    console.log('Selected job option: ', event.target.value)
  }
    ...
    <Flex
      ...
      <HStack spacing={{ base: '0', md: '6' }}>
        <Stack spacing={{ base: '0', md: '6' }}>
          {jobs ? 
            <Select placeholder='Select job' onChange={(event) => handleJobSelection(event)}>
